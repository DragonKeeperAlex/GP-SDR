...
> GP-SDR 1.5.0-rc32 is the current release candidate. On-air performance still
...
See [Architecture](Docs/ARCHITECTURE.md), [release notes](Docs/RELEASE_NOTES_1.5.0-rc32.md),
