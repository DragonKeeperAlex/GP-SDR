...
> GP-SDR 1.5.0-rc18 is the current release candidate. On-air performance still
...
```bash
sudo apt install ./gp-sdr_1.5.0-rc18_amd64.deb
...
Scripts/build_release.sh 1.5.0-rc18
```
...
See [Architecture](Docs/ARCHITECTURE.md), [release notes](Docs/RELEASE_NOTES_1.5.0-rc18.md),
