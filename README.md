...
> GP-SDR 1.5.0-rc14 is the current release candidate. On-air performance still
...
Scripts/build_release.sh 1.5.0-rc14
```
...
See [Architecture](Docs/ARCHITECTURE.md), [release notes](Docs/RELEASE_NOTES_1.5.0-rc14.md),
