...
func setupRecipes() []installerRecipe {
	return []installerRecipe{
		...
		{component: SetupComponent{ID: "rtlsdr", Name: "RTL-SDR tools", Category: "receiver",
			Guide:    "Installs librtlsdr and the rtl_test/rtl_sdr/rtl_tcp tools used for discovery and persistent live IQ capture.",
			GuideURL: "https://formulae.brew.sh/formula/librtlsdr"}, tools: []string{"rtl_test", "rtl_sdr", "rtl_tcp"}, formulae: []string{"librtlsdr"}},
		...
		{component: SetupComponent{ID: "local-ai", Name: "Local signal intelligence", Category: "integration",
			Guide:    "Installs the Ollama local model runtime. Start Ollama, run 'ollama pull qwen2.5:1.5b' once, then enable Local signal intelligence in Settings. Radio evidence stays on this computer.",
			GuideURL: "https://ollama.com/download"}, tools: []string{"ollama"}, formulae: []string{"ollama"}},
