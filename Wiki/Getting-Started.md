...
```bash
sudo apt install ./gp-sdr_1.5.0-rc14_amd64.deb
# 64-bit ARM:
sudo apt install ./gp-sdr_1.5.0-rc14_arm64.deb
...
Download packages from [GitHub Releases](https://github.com/DragonKeeperAlex/GP-SDR/releases) and check **Settings → Build → Version** after installation. Package examples target 1.5.0-rc14. Keep the previous application and a stopped-service backup of your data when updating.
