...
Download packages from [GitHub Releases](https://github.com/DragonKeeperAlex/GP-SDR/releases) and check **Settings → Build → Version** after installation. Package examples target 1.5.0-rc32. Keep the previous application and a stopped-service backup of your data when updating.
