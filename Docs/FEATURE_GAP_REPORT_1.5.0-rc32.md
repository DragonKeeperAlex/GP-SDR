...
| P0 | Complete P25 RF/audio acceptance | Follow-up testing found missing Linux USB identities allowed SDRTrunk tuner fallback, so the earlier HackRF attribution is withdrawn. The fix now isolates receivers. RTL-SDR independently locks 774.45625 MHz and generates actual unencrypted Phase 2 MP3 recordings with JMBE IMBE/AMBE loaded. The good HackRF currently appears in PortaPack mode; Pluto's short check did not lock. | Repeat an isolated good-HackRF and Pluto lock/grant/voice test. Finish live P25 audio routing into GP-SDR on headless hosts; verify subjective intelligibility and continuity, not merely valid recording files. |
