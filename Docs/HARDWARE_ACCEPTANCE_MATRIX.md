...
| 2026-09-16 | Pi/Linux ARM64 | 1.5.0-rc32 | Requested HackRF `c5cb`; actual source not isolated | native SDRTrunk | — | P25 Phase 2 | EBRCS / 774.45625 MHz | requested 10 MS/s | profile | live session | 0 observed | — | — | Lock, NAC `0x1F5`, system `0x1F1`, grants and Phase 2 frames observed; missing Linux USB identities allowed fallback to another tuner | Not accepted | runtime P25 event/log files | Attribution invalid; repeat isolated |
| 2026-09-16 | Pi/Linux ARM64 | 1.5.0-rc33-test | RTL-SDR/E4000 `00000001` | native SDRTrunk; HackRF disabled | — | P25 Phase 2 | EBRCS CCCO Central / 774.45625 MHz | 2.4 MS/s | profile | live session | 0 observed | — | — | Independently locked; valid grants and Phase 2 traffic frames; JMBE IMBE and AMBE loaded | Actual unencrypted MP3 recordings generated; one checked file is mono 16 kHz, 2.88 seconds; live web audio and subjective intelligibility pending | private runtime logs/recordings | Pass lock/record generation; live audio pending |
| 2026-09-16 | Pi/Linux ARM64 | 1.5.0-rc32 | RTL-SDR/E4000 `00000001` | same powered hub | — | USB soak | continuous IQ | 2.4 MS/s | rtl_test | 30 minutes | 76 bytes minimum lost; no disappearance | maintained stream | — | Not a decoder test | Not routed | `/tmp/gpsdr-rtl-soak.log` | Stability pass; small sample loss |
