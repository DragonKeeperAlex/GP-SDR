...
| 2026-09-15 | Pi/Linux ARM64 | 1.5.0-rc32 | HackRF ending `c5cb` | native SDRTrunk | — | P25 | EBRCS ALCO East | 10 MS/s | profile | 15 s | 0 observed | — | — | Engine stable; searching; no control identity/grant | No accepted call | runtime P25 log | Incomplete RF acceptance |
